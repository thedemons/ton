    ...
    switch (tag) {
      case block::gen::CommonMsgInfo::int_msg_info: {
        ...
        return tonlib_api::make_object<tonlib_api::raw_message>(
            ...
            fwd_fee, ihr_fee, created_lt, std::move(body_hash), get_data(src));
      }
...
auto to_tonlib_api(const vm::StackEntry& entry,
                   int& limit) -> td::Result<tonlib_api::object_ptr<tonlib_api::tvm_StackEntry>> {
  if (limit <= 0) {

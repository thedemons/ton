...
struct AuxData_ForceFiftLocation final : ASTAuxData {
  ...
  explicit AuxData_ForceFiftLocation(SrcLocation forced_loc) : forced_loc(forced_loc) {
  }
};
...
struct AuxData_LazyObjectLoadFields final : ASTAuxData {
  ...
  AuxData_LazyObjectLoadFields(LocalVarPtr var_ref, TypePtr union_variant, StructFieldPtr field_ref,
...
struct AuxData_LazyMatchForUnion final : ASTAuxData {
  ...
  AuxData_LazyMatchForUnion(LocalVarPtr var_ref, StructFieldPtr field_ref) : var_ref(var_ref), field_ref(field_ref) {
  }
};
...
struct AuxData_OnInternalMessage_getField final : ASTAuxData {
  ...
  AuxData_OnInternalMessage_getField(FunctionPtr f_onInternalMessage, std::string_view field_name)
      : f_onInternalMessage(f_onInternalMessage), field_name(field_name) {
  }
